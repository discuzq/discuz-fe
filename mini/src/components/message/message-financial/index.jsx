...
const Index = ({ message }) => {
  ...
  const formatFinancialList = (list = []) => {
    const newList = [];
    list.forEach(({
      amount, cashActualAmount, content, createdAt, id, threadId, threadTitle, type, userAvatar, userId, username, nickname, orderType, threadUserAvatar, threadNickname, threadUserNickname
    }) => {
